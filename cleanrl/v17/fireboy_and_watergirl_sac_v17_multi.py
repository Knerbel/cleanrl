...
# v17 New smaller CNN Multi ACTION SPACE
...
register(
    id="FireboyAndWatergirl_sac-v17-multi",
    entry_point="cleanrl.v17.fireboy_and_watergirl_sac_v17_multi:FireboyAndWatergirlEnv",
)
