...
register(
    id="FireboyAndWatergirl_sac-v17-generalization",
    entry_point="cleanrl.v17.fireboy_and_watergirl_sac_v17_generalization:FireboyAndWatergirlEnv",
)
