...
class FireboyAndWatergirlEnv(gym.Env):
    ...
    def _load_level(self):
        ...
        self.board = Board(
            'C:\\Users\\knerb\\Documents\\GitHub\\Knerbel-cleanrl\\fireboy_and_watergirl\\data\\'+self.level+'.txt')
    ...
    def _check_done(self):
        # and all(star.is_collected for star in self.stars)
...
register(
    id="FireboyAndWatergirl-ppo-v17-plates_and_gates",
    entry_point="cleanrl.v17.fireboy_and_watergirl_ppo_v17_plates_and_gates:FireboyAndWatergirlEnv",
)
