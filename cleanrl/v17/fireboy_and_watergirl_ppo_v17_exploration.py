...
register(
    id="FireboyAndWatergirl-ppo-v17-exploration",
    entry_point="cleanrl.v17.fireboy_and_watergirl_ppo_v17_exploration:FireboyAndWatergirlEnv",
)
