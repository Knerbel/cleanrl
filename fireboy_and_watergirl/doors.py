...
class Doors:
    ...
    def load_images(self):
        ...
        self.door_background = pygame.image.load(
            "./fireboy_and_watergirl/data/door_images/door_background.png")
...
class FireDoor(Doors):
    def __init__(self, position):
        ...
        self.door_image = pygame.image.load(
            "./fireboy_and_watergirl/data/door_images/fire_door.png")
        super().__init__()
...
class WaterDoor(Doors):
    def __init__(self, position):
        ...
        # load unique door image
        self.door_image = pygame.image.load(
            "./fireboy_and_watergirl/data/door_images/water_door.png")
        super().__init__()
